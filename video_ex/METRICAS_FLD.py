...
# === Parámetros ===
detections_file = r"/home/zzh/IMAGENES_TEST/Sessiontotal/detections_combined_rectangles.json"
annotation_files = [
    r"/home/zzh/IMAGENES_TEST/RED_TRAIN/valid/_annotations.coco.json",
    r"/home/zzh/IMAGENES_TEST/RED_TRAIN/test/_annotations.coco.json",
    r"/home/zzh/IMAGENES_TEST/RED_TRAIN/train/_annotations.coco.json"
]
image_folder = r"/home/zzh/IMAGENES_TEST/RED_TRAIN"
output_folder = r"/home/zzh/IMAGENES_TEST/visualizations"
...
def non_max_suppression(polygons, iou_thresh=0.7):
...
for filename in imagenes_a_evaluar:
    ...
    for r in detections.get(filename, []):
        ...
        if poly.is_valid and poly.area >= min_area_ratio:
            preds.append(poly)
    preds = non_max_suppression(preds, iou_thresh=0.7)
    matched = set()
